...
class SonicMTLProvider : MainProvider() {

    override val name = "SonicMTL"
    override val mainUrl = "https://www.sonicmtl.com"
    override val iconUrl = "https://www.google.com/s2/favicons?domain=sonicmtl.com&sz=64"
    ...
    override suspend fun loadMainPage(
        ...
        val order = orderBy.takeUnless { it.isNullOrEmpty() } ?: "trending"
